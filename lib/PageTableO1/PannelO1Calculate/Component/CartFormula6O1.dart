...
class CartFormula6O1 extends StatelessWidget {

  final TableO1 data;

  const CartFormula6O1({super.key,required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    String ResultFormula = '${data.Theta_Ec} + ${data.Alpha_Ec} + ${data.Beta_Eo}';

    double Res = data.Theta_Ec! + data.Alpha_Ec! + data.Beta_Eo!;
