...
class PannelTableO1Save extends StatefulWidget {

  final TableO1? data;

  const PannelTableO1Save({super.key,this.data});

  @override
  State<PannelTableO1Save> createState() => _PannelTableO1SaveState();
}

class _PannelTableO1SaveState extends State<PannelTableO1Save> {
  ...
  void initState() {
    ...
    txt_Peak_Alpha = TextEditingController(text: widget.data?.Peak_Alpha.toString());
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InputText(
                      pathPng: 'assets/wave/18.png',
                      textDirection: TextDirection.ltr,
                      textAlign: widget.data==null ? TextAlign.center : TextAlign.start,
                      hint: widget.data==null ? 'Peak-α' : null,
                      prefix: widget.data==null ? null : 'Peak-α : ',
                      textInputType: TextInputType.numberWithOptions(decimal: true,signed: true),
                      Validator: ValidFloatNumber,
                      controller: txt_Peak_Alpha,
                    ),
                  ),
              ...
              onPressed: () async {
                ...
                if(FormKey.currentState!.validate()){
                  ...
                  TableO1 tblO1 = TableO1(
                    ...
                    Peak_Alpha: double.parse(txt_Peak_Alpha.text)
                  );


                  Navigator.pop(context,tblO1);
