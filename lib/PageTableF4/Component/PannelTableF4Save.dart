...
class PannelTableF4Save extends StatefulWidget {

  final TableF4? data;

  const PannelTableF4Save({super.key,this.data});

  @override
  State<PannelTableF4Save> createState() => _PannelTableF4SaveState();
}

class _PannelTableF4SaveState extends State<PannelTableF4Save> {
