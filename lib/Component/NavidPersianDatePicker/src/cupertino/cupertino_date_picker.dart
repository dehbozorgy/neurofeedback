...
import '../../src/cupertino/strings.dart';

// import '../date/src/jalali/jalali_date.dart';
import 'picker.dart';
...
class PCupertinoDatePicker extends StatelessWidget {
  ...
  PCupertinoDatePicker({
    ...
    this.textStyleHour,
    this.textStyleMinut,
    this.datePickerDateOrder = DatePickerDateOrder.ymd,
    ...
    switch (mode) {
      ...
      case PCupertinoDatePickerMode.dateAndTime:
        return _CupertinoDatePickerDateTime(
          textStyleHour: textStyleHour,
          textStyleMinut: textStyleMinut,
  ...
  TextStyle? textStyleMonth;
  TextStyle? textStyleDay;
  TextStyle? textStyleHour;
  TextStyle? textStyleMinut;
          ...
          (int index) {
            ...
            return itemPositioningBuilder(
              ...
              Text(
                ...
                style: widget.textStyleHour ?? _themeTextStyle(context,
        ...
        children:
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: widget.textStyleMinut ?? _themeTextStyle(context, isValid: !isInvalidMinute),
            ),
          );
        }),
      ),
...
class _CupertinoDatePickerDateState extends State<_CupertinoDatePickerDate> {
        ...
        children: List<Widget>.generate(31, (int index) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: widget.textStyleDay ?? _themeTextStyle(context, isValid: day <= daysInCurrentMonth),
            ),
          );
        }),
      ),
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: widget.textStyleMonth ?? _themeTextStyle(context, isValid: !isInvalidMonth),
            ),
          );
        }),
      ),
        ...
        itemBuilder: (BuildContext context, int year) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: widget.textStyleYear ?? _themeTextStyle(context, isValid: isValidYear),
            ),
          );
        },
      ),
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.datePickerDateOrder) {
